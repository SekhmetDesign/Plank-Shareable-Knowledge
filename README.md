...
### based on : Awesome Mac [![jaywcjlove/sb](https://jaywcjlove.github.io/sb/ico/awesome.svg)](https://github.com/jaywcjlove/awesome-mac)
...
for the 21st Century by GitHub. ![star 4][star4 Icon] [![Open-Source Software][OSS Icon]](https://github.com/atom/atom) ![Freeware][Freeware Icon] ![tuijian][tuijian Icon] ![must-have][bibei Icon]
    * Common plugins
...
* [Sublime Text](http://www.sublimetext.com/3) - A sophisticated text editor for code, markup and prose. You'll love the slick user interface, extraordinary features and amazing performance.
 ![tuijian][tuijian Icon] ![must-have][bibei Icon]
...
## Command Line Tools
* [iTerm2](http://www.iterm2.com) - iTerm2 is a terminal emulator for OS X that does amazing thing. [![star 4][star4 Icon] ![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon] ![tuijian][tuijian Icon] ![must-have][bibei Icon]](https://github.com/gnachman/iTerm2)
...
## Version control
* [Git](https://git-scm.com/) - The Version Control Tool, Official website provides [dozens of GUI clients](https://git-scm.com/download/gui) [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon] ![tuijian][tuijian Icon] ![must-have][bibei Icon]](https://github.com/git/git)
...
* [GitKraken](https://www.gitkraken.com/) - beautiful Git GUI for Windows, Mac and Linux

#### Version control system
* [GitLab](http://gitlab.com/) open source git repo management software. ![Freeware][Freeware Icon] ![tuijian][tuijian Icon] ![must-have][bibei Icon]
* [Github](https://github.com) Lot code hosting, project management, presentation deployment, look, you can visit to making now。![Freeware][Freeware Icon] ![tuijian][tuijian Icon] ![必备][bibei Icon]

## DataBase
* [Sequel Pro](http://www.sequelpro.com/) - MySQL database management for Mac OS X. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon] ![must-have][bibei Icon]](https://github.com/sequelpro/sequelpro)
...
* [Slack](https://slack.com/) - Awesome tool for team collaboration and communication. ![Freeware][Freeware Icon] ![tuijian][tuijian Icon]
* [Hangout](https://hangouts.google.com/) - Free instant messaging from Google. ![Freeware][Freeware Icon] ![tuijian][tuijian Icon]
* Email
    * [Thunderbird](https://www.mozilla.org/en-US/thunderbird/) - A fast email client. For all OS.
...
* Note-taking
    * [Google Keep](http://happenapps.com/#quiver) - The Programmer's Notebook. ![tuijian][tuijian Icon]
    * [Evernote](https://evernote.com/?var=1&noredirect) - Famous note-taking app. ![Freeware][Freeware Icon] ![tuijian][tuijian Icon] ![必备][bibei Icon]
    * [OneNote](https://www.onenote.com/) - Note-taking app by MicroSoft. ![Freeware][Freeware Icon] ![tuijian][tuijian Icon] ![必备][bibei Icon]
...
* [Dropbox](https://www.dropbox.com/) - A file hosting serviced that offers cloud storage, file synchronization, personal cloud and collaborative edit. ![Freeware][Freeware Icon] ![tuijian][tuijian Icon]
* [ownCloud](https://owncloud.org) Cloud storage.

## Web Browsers
*Browsers on Mac OS*
* [Safari](http://www.apple.com/safari/) - Build-in browser of Mac OS. ![Freeware][Freeware Icon]
* [Chrome](http://www.google.com/chrome/browser/) - ![star 4][star4 Icon] Chrome, produced by Google ![Freeware][Freeware Icon]
* [Firefox](http://www.firefox.com/) - Firefox. ![Freeware][Freeware Icon]
* [Opera](http://www.opera.com) - Opera. ![Freeware][Freeware Icon]
* [Edge]() - Microsoft Edge. ![Freeware][Freeware Icon]
...
### Productivity
* **Password Management**
	* [1password](https://1password.com/) - A cross-platform password management tool. ![tuijian][tuijian Icon] ![必备][bibei Icon]
